          ...
          <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            ...
            <div className="col-span-full">
              ...
              <div class=" mt-6 col-span-full">
                ...
                >
                  Are there any specific products or brands that you would like
                  to see in our supermarket?
                </label>
                <div class="mt-2">
                  <textarea
              ...
              <fieldset className="mt-6">
                <legend className="text-sm font-semibold leading-6 text-gray-900">
                  How likely are you to recommend our supermarket to a friend or
                  family member?
                </legend>
              ...
              <fieldset className="mt-6">
                <legend className="text-sm font-semibold leading-6 text-gray-900">
                  Would you be interested in participating in a customer loyalty
